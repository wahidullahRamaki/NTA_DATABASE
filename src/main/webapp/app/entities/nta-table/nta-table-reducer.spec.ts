...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nta-table.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NTATABLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NTATABLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NTATABLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NTATABLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NTATABLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NTATABLE actions', async () => {
      const arg = 42666;
